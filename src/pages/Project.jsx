          ...
          <div className="w-screen min-h-screen ">
            <div className="w-full h-full">
              ...
              <div className="w-full flex items-center justify-center p-5">
                <div className="w-full h-full flex items-center justify-between border-2 border-orange-500 p-2 rounded-3xl">
              ...
              <div className="w-full h-full py-10 px-20 flex flex-wrap ">
              ...
              <div className="w-full h-full px-5 space-y-3 py-5">
                <h1 className="text-3xl font-bold">About this property</h1>
